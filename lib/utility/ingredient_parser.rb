  ...
  class IngredientParser
    ...
    def create_movie_ingredients_associations(movie)
      ...
      ranked_ingredients_list.each do |ingredient_object|
        MoviesIngredientsAssociations.create(movie: movie, ingredient: ingredient_object[0], mentions: ingredient_object[1], mentions_percentage: ((ingredient_object[1].to_f / movie.ingredients.length.to_f) * 100))
      end
    end
